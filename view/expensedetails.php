<?php 
if ($_GET['ecode']=='thisweek') {
$details = 'This Week';	
$detvalue=1;
$selected_todaysales = $context->select_expensescaptured_tw($oshop_code);
}else if ($_GET['ecode']=='thismonth') {
$details = 'This Month';
$detvalue=2;	
$selected_todaysales = $context->select_expensescaptured_tm($oshop_code);
}else if ($_GET['ecode']=='thisyear') {
$details = 'This Year';	
$detvalue=3;
$selected_todaysales = $context->select_expensescaptured_ty($oshop_code);
}else{
...
<h4>Expenses List</h4>
<h6>Manage your shop expenses <?php echo $details; ?></h6>
</div>
<div class="page-btn">
...
<input type="text" class="form-control" value="List of all expenses <?php echo $details; ?>" readonly style="border-radius: 0px; border: 1px solid #ff9f43;">
</div>
</div>
</div>
</div>
