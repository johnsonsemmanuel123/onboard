...
$amt_tendered = mysqli_real_escape_string($conn, $tenderedAmountx);
...
$sid = $mdata['stock_id'];
$sqty = $mdata['quantity'];
$entryChexz = $content->fnc_performsales3($sid);
if (!empty($entryChexz)) {
...
$content->update_stockpurchase_forshop($sid,$qtychex);	
$twox=1;
