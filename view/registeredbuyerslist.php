...
<h4>Buyers List</h4>
<h6>Manage your registered buyers for today</h6>
</div>
<div class="page-btn">
<a href="index.php?page=newsales" class="btn btn-added"><img src="../assets/img/icons/plus.svg" alt="img" class="me-1">Add Buyer</a>
</div>
</div>
<div class="row">
...
<input type="text" class="form-control" value="List of all registered buyers as at today <?php echo date('d-M-Y'); ?>" readonly style="border-radius: 0px; border: 1px solid #ff9f43;">
</div>
</div>
</div>
</div>
