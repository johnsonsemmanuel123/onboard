...
<h3>Buyer Sign Up</h3>
<h4>Please signup an account as a Buyer</h4>
</div>
...
<div class="form-login">
<input class="btn btn-login" type="submit" name="GrowerSignUp" value="Sign In" style="padding-bottom: 40px;background: #8ba068;">
</div>
</form>
<div class="signinform text-center">
<h4>Have an account? <a href="index.php?page=login" class="hover-a">Sign Up</a></h4>
</div>
