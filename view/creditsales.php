...
$creditamount=0;
$balanceamount=0;
$selected_todaysales = $context->select_crediteditemscentral();
...
$paida = $context->cred_payments($id);
$paidamount += $paida;
$creditamount += $countval['total_monies'] ;
$balanceamount += ($countval['total_monies']-$paida) ;
}
}
...
<h4>Credit Sales</h4>
<h6>Manage your credit sales</h6>
</div>
<div class="page-btn">
...
<div class="dash-widgetcontent"> 
<h5>GH¢
<span class="counters" data-count="<?php echo number_format($paidamount,2); ?>"></span>
</h5>
...
<input type="text" class="form-control" value="List of all credit sales as at today <?php echo date('d-M-Y'); ?> and payment history" readonly style="border-radius: 0px; border: 1px solid #ff9f43;">
</div>
</div>
</div>
</div>
...
<td align="right" style="font-weight: bold"><?php echo number_format($data['total_monies'],2); ?></td>
