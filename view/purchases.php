...
$selected_activelist = $context->branch_saleslist(); 
$user = $_SESSION['username'];
$allsum = $context->shopselect_sum($user);
$alltax = $context->fnc_tax();
$alltotal = $allsum+$alltax;
$hiddencode = $context->shop_transcode(5);
?>
...
<form method="POST" action="../controller/branchSalesController.php">
<div class="row">
<div class="col-12">
...
<form method="POST" action="../controller/mainshopsalesController.php">
...
<a href="../controller/mainshopsalesController.php?clearcode=123">Clear all</a>
</div>
...
<tbody>
<?php 
$selected_itemlistx = $context->sales_shopitemsz($user); 
...
<input type="hidden" name="hiddenvaluex" id="hiddenvaluex">
<input type="button" value="-" id="minusBtnx" class="button-minus dec button" data-idx="<?= $id; ?>">
<input type="text" name="child" id="valueSpacex<?php echo $id; ?>" value="<?php echo $subqty; ?>" class="quantity-field">
<input type="button" value="+" id="plusBtnx" class="button-plus inc button" data-idz="<?= $id; ?>">
</div>
</div>
</center>
</td>
<td class="text-center">
<a id="cartdeletedx" href="#" data-id="<?= $id; ?>"><img src="../assets/img/icons/delete-2.svg" alt="img"></a>
</td>
</tr>
<?php 
}
...
<input type="text" name="tenderedAmountx" id="tenderedAmountx" required style='color: green;font-weight: bolder;text-align: right;'>
</div>
</div>
