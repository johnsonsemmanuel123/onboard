...
$creditamount=0;
$balanceamount=0;
$selected_todaysales = $context->shop_saleslist_today($oshop_code);
...
$paida = $context->cred_payments_shop();
$paidamount += $paida;
...
<div class="dash-widgetcontent">
<h5>GH¢
<span class="counters" data-count="<?php echo $creditamount; ?>">
</span>
</h5>
...
<div class="dash-widgetcontent"> 
<h5>GH¢
<span class="counters" data-count="<?php echo $paida; ?>"></span>
</h5>
...
<div class="dash-widgetcontent">
<h5>GH¢
<span class="counters" data-count="<?php echo $balanceamount; ?>">
</span></h5>
...
$amount_paid_already = $context->cred_payments3($id)
?>
<tr>
