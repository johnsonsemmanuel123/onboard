<?php $dashboard_summaries = $context->branch_transfer($oshop_code);?>
<div class="page-wrapper">
<div class="content">
<div class="page-header">
<div class="page-title">
<h4>Transferred Stock</h4>
<h6>Manage your Products Transferred from Central Shop</h6>
</div>
<div class="page-btn">
...
<h5>
<span class="counters" data-count="<?php echo $dashboard_summaries['total_qtyintransfer']; ?>">
</span>
</h5>
<h6>Stock Qty In Transfer</h6>
</div>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
...
<div class="dash-widgetcontent">
<h5>GHC
<span class="counters" data-count="<?php echo $dashboard_summaries['total_amountintransfer']; ?>">
</span>
</h5>
<h6>Stock Amount In Transfer</h6>
</div>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
...
<div class="dash-widgetcontent"> 
<h5>
<span class="counters"><?php echo $dashboard_summaries['total_datetransfer']; ?></span>
</h5>
<h6>Stock Transferred Date</h6>
</div>
</div>
</div>
</div>
...
<?php $rowbatchlist = $context->select_transferxstock(); ?>
