 ...
 */
    ...
    abstract class NotifyRequest {
        ...
        public static function initShared(){
            ...
            // global flag for using secured https or http connection
        ...
        public static function useSecureConnection($secure, $port = null){
        ...
        public function submit(){
            ...
            if (self::$_gSecureConn) {
                if (!file_exists(self::$caInfoFileName))
                    throw new \Exception('The Certificate Authorities file for secure connection was not found.');
